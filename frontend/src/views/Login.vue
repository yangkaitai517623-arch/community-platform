    ...
    <aside class="auth-aside">
      ...
      <div class="aside-content">
        ...
        <div class="aside-body">
          <p class="aside-eyebrow">便民服务 · 邻里互助</p>
        ...
        <div class="aside-foot">
          <div class="meta-row">
            ...
            <span class="meta-val tabular">2024</span>
          </div>
          <div class="meta-row">
          ...
          <div class="meta-row">
            <span class="meta-label">完成服务</span>
    ...
    <main class="auth-main">
      <div class="auth-card">
        ...
        <header class="auth-card-header">
          <span class="card-eyebrow">登 录</span>
          <h2 class="card-title">欢迎回来</h2>
          <p class="card-sub">继续你在社区里的事</p>
        </header>
        ...
        <footer class="auth-card-foot">
          <span>新邻居？</span>
          <router-link to="/register" class="link">在这里注册</router-link>
        </footer>

        <div class="demo-hint">
          <span class="demo-dot"></span>
          <span>演示账号 admin · 密码 admin123</span>
        </div>
      </div>
    </main>
  </div>
...
import { UserRound, KeyRound, Eye, EyeOff, ArrowLeft } from 'lucide-vue-next'
...
.aside-grain {
  ...
  inset: 0;
  background-image:
    radial-gradient(circle at 20% 30%, rgba(178,59,42,0.10) 0%, transparent 50%),
    radial-gradient(circle at 80% 80%, rgba(201,122,63,0.06) 0%, transparent 60%);
  pointer-events: none;
}
.aside-grain::after {
  content: '';
...
.field-action:hover { color: var(--admin-stamp); }
...
@media (max-width: 960px) {
  ...
  .aside-body { margin: 32px 0; }
  .aside-headline { font-size: 36px; }
