-- ============================================
-- 青青社区便民服务平台 - 最终整合版数据库脚本
-- ============================================
-- 用途：
-- 1. 新环境首次部署时，优先执行本文件完成建库、建表和示例数据初始化。
-- 2. database/ 目录下其他 add-*/fix-*/backfill-*/check-* 脚本保留为历史迁移和维护记录。
-- 3. 如果从零创建数据库，不需要再逐个执行迁移脚本，直接使用本最终整合版脚本即可。
-- ============================================
...
CREATE TABLE goods_order (
    ...
    status TINYINT DEFAULT 0 COMMENT '状态: 0-待确认 1-已确认 2-已完成 4-已取消',
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE repair_order (
    ...
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY uk_repair_order_request (request_id),
...
('admin', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '系统管理员', 2, 1);
...
('zhangsan', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '张女士', '13800138001', '3栋', '502', 0, 1),
('lisi', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '李先生', '13800138002', '5栋', '301', 0, 1),
('wangwu', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '王先生', '13800138003', '8栋', '301', 0, 1),
('zhaoliu', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '赵女士', '13800138004', '12栋', '102', 0, 1);

-- 示例师傅（专职维修人员）
INSERT INTO sys_user (username, password, real_name, phone, role, status) VALUES
('worker1', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '王师傅', '13900139001', 3, 1),
('worker2', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '李师傅', '13900139002', 3, 1),
('worker3', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '张师傅', '13900139003', 3, 1);
